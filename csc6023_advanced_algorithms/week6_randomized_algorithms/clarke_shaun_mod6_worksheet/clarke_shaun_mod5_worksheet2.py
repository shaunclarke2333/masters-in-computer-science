...
class Monaco:
    ...
    def monte_carlo(ten_k_array: List[int], k: int = 1):
        ...
        return None, None, count_attempts
...
def main():
    ...
    if item and item_index != None:
        ...
        # In the event no 1's were found.
        print(f"The house always wins, you have exhausted all your chips Mr. Bond after {count_attempts} attempts")
